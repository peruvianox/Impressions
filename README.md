...
o A spreadsheet containing the most relevant figures, metrics, and ratios from analysis
• Various Figures
o PNG files of the force distributions and close up still images (pg 3&4 of report)
• Saved ***_Results.mat file
o This file contains all the saved data from the matlab workspace so that the data may be saved in an analysis-friendly version for future reference. Most data are stored in the “DynamicPPTrials” or “Regions” structures.
• GIF movie files for each
o If selected, these GIFs show the dynamic pressure distribution and CoP progression. The black dot shows the CoP for the current frame, while the red dots show the COP from the preceding 3 frames so that CoP velocity may be better interpreted.
...
Impressions
Plantar Pressure Gait Analysis
5
General
...
66% CoP Mask Definition
66% CoP Mask Definition
CoP Mask Definition
CoP Mask Definition
Heel Centroid Mask Definition
Heel Centroid Mask Definition
Impressions
Plantar Pressure Gait Analysis
6
...
Peak Identification (left foot)
Peak Identification (left foot)
Peak Identification (
Peak Identification (rightright foot)foot)
Inter
Inter--Peak Mask DefinitionPeak Mask Definition
Overall M
Overall Mask Segmentationask Segmentation
Impressions
Plantar Pressure Gait Analysis
7
