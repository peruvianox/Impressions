...
![Select Points](Img/SelectPoints.PNG)
...
![Heel-Centroid Mask](Img/HCMask.PNG)
...
![Inter Peak Mask](Img/IPMask.PNG)
...
![Mask Segmentation](Img/MaskSegmentation.PNG)
...
![Average Step Profiles](Img/AvgStepCoP.PNG)
...
![Orientation Accuracy Plot](Img/OrientationAccuracy.PNG)
...
![Temporal Spatial Validation](Img/TemporalSpatialValidation.PNG)
...
![Impressions Novel Validation](Img/ImpressionsNovelValidation.PNG)
